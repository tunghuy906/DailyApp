...
namespace DailyPlannerApp
{
    ...
    public class VocabForm : Form
    {
        ...
        TabPage BuildNotesTab()
        {
            ...
            var right = new Panel { Left=252,Top=0,Width=640,Height=500 };
            page.Controls.Add(right);

            txtSearch = new TextBox { Left=12,Top=12,Width=300,Font=new Font("Segoe UI",10),PlaceholderText="Search word or meaning..." };
            txtSearch.TextChanged += (s,e) => ApplyFilter();
            right.Controls.Add(txtSearch);

            btnDelete = new Button { Left=320,Top=10,Width=90,Height=30,Text="Delete",
                Font=new Font("Segoe UI",9,FontStyle.Bold),BackColor=Color.FromArgb(254,242,242),
                ForeColor=C_RED,FlatStyle=FlatStyle.Flat };
            ...
            grid = new DataGridView { Left=12,Top=50,Width=618,Height=410,
                BackgroundColor=C_WHITE,BorderStyle=BorderStyle.None,RowHeadersVisible=false,
                AllowUserToAddRows=false,AllowUserToDeleteRows=false,AllowUserToResizeRows=false,
                SelectionMode=DataGridViewSelectionMode.FullRowSelect,ReadOnly=true,
                Font=new Font("Segoe UI",10),EnableHeadersVisualStyles=false,GridColor=C_BORDER,
                ColumnHeadersHeight=36,CellBorderStyle=DataGridViewCellBorderStyle.SingleHorizontal };
            grid.RowTemplate.Height=32;
            grid.ColumnHeadersDefaultCellStyle.BackColor=Color.FromArgb(241,245,249);
            grid.ColumnHeadersDefaultCellStyle.ForeColor=C_SUB;
        ...
        void RefreshDaily10()
        {
            ...
            var lblW = new Label {
                ...
                ForeColor=written==10?C_GREEN:C_SUB,Left=0,Top=y+4,Width=860,Height=22 };
        ...
        Panel BuildWordCard(MasterWord w,int num,int top,HashSet<string> myWords)
        {
            ...
            var badge = new Label { Text=num.ToString(),Left=10,Top=14,Width=28,Height=28,
                TextAlign=ContentAlignment.MiddleCenter,Font=new Font("Segoe UI",9,FontStyle.Bold),
                ForeColor=C_ACCENT,BackColor=Color.FromArgb(239,246,255) };
            card.Controls.Add(badge);

            var lblWord = new Label { Text=w.Word,Left=46,Top=10,Width=200,Height=22,
                Font=new Font("Segoe UI",12,FontStyle.Bold),ForeColor=C_TEXT };
            card.Controls.Add(lblWord);

            var chip = new Label { Text=w.Topic,Left=46,Top=32,Width=120,Height=16,
                Font=new Font("Segoe UI",7.5f),ForeColor=C_SUB };
            card.Controls.Add(chip);

            var lblMeaning = new Label { Text=w.Meaning,Left=260,Top=18,Width=360,
                Font=new Font("Segoe UI",10.5f),ForeColor=Color.FromArgb(71,85,105) };
            card.Controls.Add(lblMeaning);

            var btn = new Button {
                Text=already?"Written":"Write it",Left=636,Top=13,Width=100,Height=30,
                Font=new Font("Segoe UI",8.5f,FontStyle.Bold),
                BackColor=already?Color.FromArgb(240,253,244):Color.FromArgb(239,246,255),
                ForeColor=already?C_GREEN:C_ACCENT,FlatStyle=FlatStyle.Flat,
                Enabled=!already,Cursor=already?Cursors.Default:Cursors.Hand };
        ...
        TabPage BuildQuizTab()
        {
            ...
            lblQuizWord = new Label { Left=30,Top=86,Width=800,Height=70,
                Font=new Font("Segoe UI",32,FontStyle.Bold),ForeColor=C_TEXT,AutoSize=false,TextAlign=ContentAlignment.MiddleLeft };
            panel.Controls.Add(lblQuizWord);

            var lblDir = new Label { Text="What is the Vietnamese meaning?",Left=30,Top=162,Width=500,Height=22,
                Font=new Font("Segoe UI",10,FontStyle.Italic),ForeColor=C_SUB };
        ...
        {
            using var popup=new Form{Text=string.Format("Edit — {0}",item.Word),Size=new Size(420,310),
                StartPosition=FormStartPosition.CenterParent,FormBorderStyle=FormBorderStyle.FixedDialog,
                MaximizeBox=false,MinimizeBox=false,BackColor=C_WHITE};
